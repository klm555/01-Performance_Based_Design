...
# Wall input 정보 (xlsx)
wall_raw_xlsx_dir = r'C:\Users\hwlee\Desktop\Python\내진성능설계'
wall_raw_xlsx = 'Data Conversion_Shear Wall Type_Ver.1.2_220214.xlsx'

wall_raw_xlsx_sheet = 'Wall Properties'
story_info_xlsx_sheet = 'Story Data'
naming_criteria_xlsx_sheet = 'ETC'
material_info_xlsx_sheet = 'Materials'


# 해석 output 파일 (txt)
H1_txt_dir = r'D:\이형우\내진성능평가\광명 4R\해석 결과\101\H1'
H2_txt_dir = r'D:\이형우\내진성능평가\광명 4R\해석 결과\101\H2'
V_txt_dir = r'D:\이형우\내진성능평가\광명 4R\해석 결과\101\V'
...
# Material 데이터베이스 load
material_database = pd.read_excel(wall_raw_xlsx_dir+'\\'+wall_raw_xlsx,
                                  sheet_name = material_info_xlsx_sheet, skiprows=3, header=0)
...
DCR_output.sort_values(by=['최대 DCR'])
